	<section class="content-header">
		<span class="content-title"><i class="fa fa-home"></i> Customer form for ordering</span>
	</section>
			...
			<div class="col-sm-6 col-xs-12">
				<div class="box-infos-search">
					<section class="content-header box-infos-header">
						<span class="content-title"> Delivery form</span>
					</section>
					<div class="box-infos">
			...
			<div class="row">
					<div class="col-xs-12 box-infos-search">
						<section class="content-header box-infos-header">
							...
							<?php if(!isset($delivery_form_clt_art)){ ?>
						...
						<div class="box-infos">
							<?php if(isset($delivery_form_clt_art)){ ?>
								<input type="hidden" value="<?= $delivery_form_clt_art->id ?>" name="art_id" class="box-infos-id">
								<h3 class="box-infos-desig"><?= $delivery_form_clt_art->desig ?></h3>
								<p class="box-infos-ref"><?= $delivery_form_clt_art->ref ?></p>
							<?php } else { ?>
								<input type="hidden"
									   name="art_id"
									   class="box-infos-id"
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						<?=  $form->input('total', 'Total', [
							'type' => 'text',
							'value' => isset($delivery_form_clt_art->total) ? $delivery_form_clt_art->total : '0.00',
							'id' => 'total',
							'readonly' => 'readonly',
