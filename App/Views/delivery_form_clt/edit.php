<section class="content-header">
    <span class="content-title"><i class="fa fa-edit"></i> Adding and editing delivery products</span>
</section>
            ...
            <div class="col-xs-12">
                <div class="box-infos-search">
                    ...
                    <div class="box-infos">
                        ...
                        <input type="hidden" value="<?= $delivery_form->client_id ?>" name="box-infos-id" class="box-infos-id">
                        <h3 class="box-infos-name"><?= $delivery_form->client_name ?></h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?=  $form->input('dt', 'Date', [
                    ...
                    'data-validation-error-msg' => 'please add your date like this: dd-mm-yyy'
                ]); ?>
