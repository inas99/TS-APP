<section class="content-header">
    <span class="content-title"><i class="fa fa-edit"></i> Adding A Price Request</span>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?=  $form->input('dt', 'Date', [
                    ...
                    'data-validation-error-msg' => 'Date would be in format as : dd-mm-yyy'
                ]); ?>
            ...
            <div class="col-lg-12 form-group text-center">
                <hr>
                <button type="submit" id="btn-save-pr_clt" class="btn btn-primary">Save</button>
            </div>
        </div>
    </form>
</section>
