	<section class="content-header">
		<span class="content-title"><i class="fa fa-home"></i> Access Rights</span>
	...
	<section class="content">
		<div class="table-responsive">
			...
			foreach($roles as $role): ?>
				...
				<?php if(isset($_SESSION['user']) && $_SESSION['user']->aed_users_roles): ?>
					<a href="<?= App::$path ?>role/edit/<?= $role->id ?>" class="btn btn-warning btn-xs">Edit</a>
						<?php if($role->id > 1){ ?>
					...
					<td class="td-roles">
						<p>
							...
							<?php if($role->aed_clients){ ?>
								...
								<i class="fa fa-plus-circle" title="Adding right"></i>
						...
						<p>
							...
							<?php if($role->aed_suppliers){ ?>
								<span class="fa-roles-true">
								<i class="fa fa-plus-circle" title="Adding rights"></i>
								<i class="fa fa-edit"></i>
								<i class="fa fa-remove"></i>
							</span>
							<?php } else { ?>
						...
						<p>
							...
							<?php if($role->aed_sales){ ?>
								<span class="fa-roles-true">
								<i class="fa fa-plus-circle" title="Access Rights"></i>
								<i class="fa fa-edit"></i>
								<i class="fa fa-remove"></i>
							</span>
							<?php } else { ?>
						...
						<p>
							<span>Users And Access Rights : </span>
							<?php if($role->aed_users_roles){ ?>
								<span class="fa-roles-true">
								<i class="fa fa-plus-circle" title="Access Right"></i>
								<i class="fa fa-edit"></i>
								<i class="fa fa-remove"></i>
							</span>
							<?php } else { ?>
