	<section class="content-header">
		<span class="content-title"><i class="fa fa-home"></i>Products Request</span>
			...
			foreach($purchase_orders_clt as $purchase_order_clt): ?>
				<tr>
					<td class="table-actions">
						<a href="<?= App::$path ?>purchase_order_clt/printdetails/<?= $purchase_order_clt->id ?>" target="_blank" class="btn btn-default btn-xs">Print</a>
				<?php if(isset($_SESSION['user']) && $_SESSION['user']->aed_articles): ?>
					<a href="<?= App::$path ?>purchase_order_clt/edit/<?= $purchase_order_clt->id ?>" class="btn btn-warning btn-xs">Edit</a>
						<a href="#" class="btn btn-danger btn-xs" purchase_order_id="<?= $purchase_order_clt->id ?>" onclick="deleteElement(this, event);">Delete</a>
					<a href="<?= App::$path ?>purchase_order_clt/articles/<?= $purchase_order_clt->id ?>" class="btn btn-primary btn-xs">Products</a>
