<section class="content-header">
    <span class="content-title"><i class="fa fa-edit"></i> Products Request</span>
</section>
<section class="content">
    <form method="post" name="form-purchase_order-add" id="form-purchase_order-add" enctype="multipart/form-data">
            ...
            <div class="col-xs-12">
                <div class="box-infos-search">
                    ...
                    <div class="box-infos">
                        ...
                        <input type="hidden" value="<?= $purchase_order->client_id ?>" name="box-infos-id" class="box-infos-id">
                        <h3 class="box-infos-name"><?= $purchase_order->client_name ?></h3>
                        <p class="box-infos-city"><?= $purchase_order->city ?></p>
                        <p class="box-infos-address"><?= $purchase_order->address ?></p>
                        <?php } else { ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?=  $form->input('dt', 'Date', [
                    ...
                    'data-validation-error-msg' => 'Date must be in this format: dd-mm-yyy'
                ]); ?>
            ...
            <div class="col-lg-12 form-group text-center">
                <hr>
                <button type="submit" id="btn-save-purchase_order" class="btn btn-primary">Save</button>
            </div>
        </div>
    </form>
</section>
