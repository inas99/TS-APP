<section class="content-header">
    <span class="content-title"><i class="fa fa-edit"></i> Add A Price Offers</span>
</section>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <?=  $form->input('dt', 'Date', [
                    ...
                    'data-validation-error-msg' => 'Date Format is as : dd-mm-yyy'
                ]); ?>
            ...
            <div class="col-lg-12 form-group text-center">
                <hr>
                <button type="submit" id="btn-save-quotation" class="btn btn-primary">Save</button>
            </div>
        </div>
    </form>
</section>
